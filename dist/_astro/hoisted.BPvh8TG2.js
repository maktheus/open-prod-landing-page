function Si(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function cf(r,e){r.prototype=Object.create(e.prototype),r.prototype.constructor=r,r.__proto__=e}/*!
 * GSAP 3.14.2
 * https://gsap.com
 *
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function Th(){return new tr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Hc(),fragmentShader:`
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function bh(){return new tr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Hc(),fragmentShader:`
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var qt,lo,Dn,Vi,Wi,ds,Hd,mr,js,Vd,Ai,ti,Wd,Xd=function(){return qt||typeof window<"u"&&(qt=window.gsap)&&qt.registerPlugin&&qt},Yd=1,os=[],tt=[],di=[],Zs=Date.now,lc=function(e,t){return t},YM=function(){var e=js.core,t=e.bridge||{},n=e._scrollers,i=e._proxies;n.push.apply(n,tt),i.push.apply(i,di),tt=n,di=i,lc=function(o,a){return t[o](a)}},ji=function(e,t){return~di.indexOf(e)&&di[di.indexOf(e)+1][t]},Js=function(e){return!!~Vd.indexOf(e)},on=function(e,t,n,i,s){return e.addEventListener(t,n,{passive:i!==!1,capture:!!s})},an=function(e,t,n,i){return e.removeEventListener(t,n,!!i)},Ya="scrollLeft",qa="scrollTop",cc=function(){return Ai&&Ai.isPressed||tt.cache++},Ro=function(e,t){var n=function i(s){if(s||s===0){Yd&&(Dn.history.scrollRestoration="manual");var o=Ai&&Ai.isPressed;s=i.v=Math.round(s)||(Ai&&Ai.iOS?1:0),e(s),i.cacheID=tt.cache,o&&lc("ss",s)}else(t||tt.cache!==i.cacheID||lc("ref"))&&(i.cacheID=tt.cache,i.v=e());return i.v+i.offset};return n.offset=0,e&&n},mn={s:Ya,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:Ro(function(r){return arguments.length?Dn.scrollTo(r,Ft.sc()):Dn.pageXOffset||Vi[Ya]||Wi[Ya]||ds[Ya]||0})},Ft={s:qa,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:mn,sc:Ro(function(r){return arguments.length?Dn.scrollTo(mn.sc(),r):Dn.pageYOffset||Vi[qa]||Wi[qa]||ds[qa]||0})},gn=function(e,t){return(t&&t._ctx&&t._ctx.selector||qt.utils.toArray)(e)[0]||(typeof e=="string"&&qt.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},qM=function(e,t){for(var n=t.length;n--;)if(t[n]===e||t[n].contains(e))return!0;return!1},nr=function(e,t){var n=t.s,i=t.sc;Js(e)&&(e=Vi.scrollingElement||Wi);var s=tt.indexOf(e),o=i===Ft.sc?1:2;!~s&&(s=tt.push(e)-1),tt[s+o]||on(e,"scroll",cc);var a=tt[s+o],l=a||(tt[s+o]=Ro(ji(e,n),!0)||(Js(e)?i:Ro(function(c){return arguments.length?e[n]=c:e[n]})));return l.target=e,a||(l.smooth=qt.getProperty(e,"scrollBehavior")==="smooth"),l},uc=function(e,t,n){var i=e,s=e,o=Zs(),a=o,l=t||50,c=Math.max(500,l*3),u=function(g,_){var m=Zs();_||m-o>l?(s=i,i=g,a=o,o=m):n?i+=g:i=s+(g-s)/(m-a)*(o-a)},h=function(){s=i=n?0:i,a=o=0},f=function(g){var _=a,m=s,p=Zs();return(g||g===0)&&g!==i&&u(g),o===a||p-a>c?0:(i+(n?m:-m))/((n?p:o)-_)*1e3};return{update:u,reset:h,getVelocity:f}},Os=function(e,t){return t&&!e._gsapAllow&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},Wh=function(e){var t=Math.max.apply(Math,e),n=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(n)?t:n},qd=function(){js=qt.core.globals().ScrollTrigger,js&&js.core&&YM()},$d=function(e){return qt=e||Xd(),!lo&&qt&&typeof document<"u"&&document.body&&(Dn=window,Vi=document,Wi=Vi.documentElement,ds=Vi.body,Vd=[Dn,Vi,Wi,ds],qt.utils.clamp,Wd=qt.core.context||function(){},mr="onpointerenter"in ds?"pointer":"mouse",Hd=Pt.isTouch=Dn.matchMedia&&Dn.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in Dn||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,ti=Pt.eventTypes=("ontouchstart"in Wi?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Wi?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return Yd=0},500),qd(),lo=1),lo};mn.op=Ft;tt.cache=0;var Pt=function(){function r(t){this.init(t)}var e=r.prototype;return e.init=function(n){lo||$d(qt)||console.warn("Please gsap.registerPlugin(Observer)"),js||qd();var i=n.tolerance,s=n.dragMinimum,o=n.type,a=n.target,l=n.lineHeight,c=n.debounce,u=n.preventDefault,h=n.onStop,f=n.onStopDelay,d=n.ignore,g=n.wheelSpeed,_=n.event,m=n.onDragStart,p=n.onDragEnd,S=n.onDrag,v=n.onPress,M=n.onRelease,w=n.onRight,A=n.onLeft,E=n.onUp,D=n.onDown,x=n.onChangeX,y=n.onChangeY,N=n.onChange,U=n.onToggleX,j=n.onToggleY,L=n.onHover,O=n.onHoverEnd,H=n.onMove,X=n.ignoreCheck,Y=n.isNormalizer,$=n.onGestureStart,C=n.onGestureEnd,Z=n.onWheel,ne=n.onEnable,q=n.onDisable,K=n.onClick,se=n.scrollSpeed,_e=n.capture,de=n.allowClicks,Ce=n.lockAxis,Pe=n.onLockAxis;this.target=a=gn(a)||Wi,this.vars=n,d&&(d=qt.utils.toArray(d)),i=i||1e-9,s=s||0,g=g||1,se=se||1,o=o||"wheel,touch,pointer",c=c!==!1,l||(l=parseFloat(Dn.getComputedStyle(ds).lineHeight)||22);var Ue,Ge,z,He,me,Le,ge,k=this,Fe=0,R=0,T=n.passive||!u&&n.passive!==!1,F=nr(a,mn),ee=nr(a,Ft),Q=F(),te=ee(),pe=~o.indexOf("touch")&&!~o.indexOf("pointer")&&ti[0]==="pointerdown",ue=Js(a),ce=a.ownerDocument||Vi,be=[0,0,0],ke=[0,0,0],J=0,st=function(){return J=Zs()},we=function(xe,Re){return(k.event=xe)&&d&&qM(xe.target,d)||Re&&pe&&xe.pointerType!=="touch"||X&&X(xe,Re)},Ve=function(){k._vx.reset(),k._vy.reset(),Ge.pause(),h&&h(k)},Ee=function(){var xe=k.deltaX=Wh(be),Re=k.deltaY=Wh(ke),ie=Math.abs(xe)>=i,Oe=Math.abs(Re)>=i;N&&(ie||Oe)&&N(k,xe,Re,be,ke),ie&&(w&&k.deltaX>0&&w(k),A&&k.deltaX<0&&A(k),x&&x(k),U&&k.deltaX<0!=Fe<0&&U(k),Fe=k.deltaX,be[0]=be[1]=be[2]=0),Oe&&(D&&k.deltaY>0&&D(k),E&&k.deltaY<0&&E(k),y&&y(k),j&&k.deltaY<0!=R<0&&j(k),R=k.deltaY,ke[0]=ke[1]=ke[2]=0),(He||z)&&(H&&H(k),z&&(m&&z===1&&m(k),S&&S(k),z=0),He=!1),Le&&!(Le=!1)&&Pe&&Pe(k),me&&(Z(k),me=!1),Ue=0},ve=function(xe,Re,ie){be[ie]+=xe,ke[ie]+=Re,k._vx.update(xe),k._vy.update(Re),c?Ue||(Ue=requestAnimationFrame(Ee)):Ee()},We=function(xe,Re){Ce&&!ge&&(k.axis=ge=Math.abs(xe)>Math.abs(Re)?"x":"y",Le=!0),ge!=="y"&&(be[2]+=xe,k._vx.update(xe,!0)),ge!=="x"&&(ke[2]+=Re,k._vy.update(Re,!0)),c?Ue||(Ue=requestAnimationFrame(Ee)):Ee()},Ze=function(xe){if(!we(xe,1)){xe=Os(xe,u);var Re=xe.clientX,ie=xe.clientY,Oe=Re-k.x,Ie=ie-k.y,Ye=k.isDragging;k.x=Re,k.y=ie,(Ye||(Oe||Ie)&&(Math.abs(k.startX-Re)>=s||Math.abs(k.startY-ie)>=s))&&(z||(z=Ye?2:1),Ye||(k.isDragging=!0),We(Oe,Ie))}},lt=k.onPress=function(Te){we(Te,1)||Te&&Te.button||(k.axis=ge=null,Ge.pause(),k.isPressed=!0,Te=Os(Te),Fe=R=0,k.startX=k.x=Te.clientX,k.startY=k.y=Te.clientY,k._vx.reset(),k._vy.reset(),on(Y?a:ce,ti[1],Ze,T,!0),k.deltaX=k.deltaY=0,v&&v(k))},fe=k.onRelease=function(Te){if(!we(Te,1)){an(Y?a:ce,ti[1],Ze,!0);var xe=!isNaN(k.y-k.startY),Re=k.isDragging,ie=Re&&(Math.abs(k.x-k.startX)>3||Math.abs(k.y-k.startY)>3),Oe=Os(Te);!ie&&xe&&(k._vx.reset(),k._vy.reset(),u&&de&&qt.delayedCall(.08,function(){if(Zs()-J>300&&!Te.defaultPrevented){if(Te.target.click)Te.target.click();else if(ce.createEvent){var Ie=ce.createEvent("MouseEvents");Ie.initMouseEvent("click",!0,!0,Dn,1,Oe.screenX,Oe.screenY,Oe.clientX,Oe.clientY,!1,!1,!1,!1,0,null),Te.target.dispatchEvent(Ie)}}})),k.isDragging=k.isGesturing=k.isPressed=!1,h&&Re&&!Y&&Ge.restart(!0),z&&Ee(),p&&Re&&p(k),M&&M(k,ie)}},re=function(xe){return xe.touches&&xe.touches.length>1&&(k.isGesturing=!0)&&$(xe,k.isDragging)},P=function(){return(k.isGesturing=!1)||C(k)},ae=function(xe){if(!we(xe)){var Re=F(),ie=ee();ve((Re-Q)*se,(ie-te)*se,1),Q=Re,te=ie,h&&Ge.restart(!0)}},oe=function(xe){if(!we(xe)){xe=Os(xe,u),Z&&(me=!0);var Re=(xe.deltaMode===1?l:xe.deltaMode===2?Dn.innerHeight:1)*g;ve(xe.deltaX*Re,xe.deltaY*Re,0),h&&!Y&&Ge.restart(!0)}},Ne=function(xe){if(!we(xe)){var Re=xe.clientX,ie=xe.clientY,Oe=Re-k.x,Ie=ie-k.y;k.x=Re,k.y=ie,He=!0,h&&Ge.restart(!0),(Oe||Ie)&&We(Oe,Ie)}},De=function(xe){k.event=xe,L(k)},it=function(xe){k.event=xe,O(k)},ot=function(xe){return we(xe)||Os(xe,u)&&K(k)};Ge=k._dc=qt.delayedCall(f||.25,Ve).pause(),k.deltaX=k.deltaY=0,k._vx=uc(0,50,!0),k._vy=uc(0,50,!0),k.scrollX=F,k.scrollY=ee,k.isDragging=k.isGesturing=k.isPressed=!1,Wd(this),k.enable=function(Te){return k.isEnabled||(on(ue?ce:a,"scroll",cc),o.indexOf("scroll")>=0&&on(ue?ce:a,"scroll",ae,T,_e),o.indexOf("wheel")>=0&&on(a,"wheel",oe,T,_e),(o.indexOf("touch")>=0&&Hd||o.indexOf("pointer")>=0)&&(on(a,ti[0],lt,T,_e),on(ce,ti[2],fe),on(ce,ti[3],fe),de&&on(a,"click",st,!0,!0),K&&on(a,"click",ot),$&&on(ce,"gesturestart",re),C&&on(ce,"gestureend",P),L&&on(a,mr+"enter",De),O&&on(a,mr+"leave",it),H&&on(a,mr+"move",Ne)),k.isEnabled=!0,k.isDragging=k.isGesturing=k.isPressed=He=z=!1,k._vx.reset(),k._vy.reset(),Q=F(),te=ee(),Te&&Te.type&&lt(Te),ne&&ne(k)),k},k.disable=function(){k.isEnabled&&(os.filter(function(Te){return Te!==k&&Js(Te.target)}).length||an(ue?ce:a,"scroll",cc),k.isPressed&&(k._vx.reset(),k._vy.reset(),an(Y?a:ce,ti[1],Ze,!0)),an(ue?ce:a,"scroll",ae,_e),an(a,"wheel",oe,_e),an(a,ti[0],lt,_e),an(ce,ti[2],fe),an(ce,ti[3],fe),an(a,"click",st,!0),an(a,"click",ot),an(ce,"gesturestart",re),an(ce,"gestureend",P),an(a,mr+"enter",De),an(a,mr+"leave",it),an(a,mr+"move",Ne),k.isEnabled=k.isPressed=k.isDragging=!1,q&&q(k))},k.kill=k.revert=function(){k.disable();var Te=os.indexOf(k);Te>=0&&os.splice(Te,1),Ai===k&&(Ai=0)},os.push(k),Y&&Js(a)&&(Ai=k),k.enable(_)},XM(r,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),r}();Pt.version="3.14.2";Pt.create=function(r){return new Pt(r)};Pt.register=$d;Pt.getAll=function(){return os.slice()};Pt.getById=function(r){return os.filter(function(e){return e.vars.id===r})[0]};Xd()&&qt.registerPlugin(Pt);/*!
